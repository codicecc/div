...
<br>
        ...
        <div class="col-md-9">
          <div class="hero-unit">
            <h1>Benvenuto nella Guida online!</h1>
 ...
 <div class="container-fluid">
  ...
  Suddivisione dell'applicazione
	...
	<div class="row">
		<h3>Misure</h3>
		<ul>
			<li><a href="/admin/school">Scuola</a></li>
			<li><a href="/admin/student">Studente</a></li>
			<li><a href="/admin/measure">Misura</a></li>
			<li><a href="/admin/body/part">Parte del corpo</a></li>
		</ul>
		<h3>Modelli</h3>
		<ul>
			<li>Modello</li>
		...
		<h3>Guida</h3>
		<ul>
			<li><a href="/admin/help">Guida</a></li>
			<li><a href="/admin/info">Informazioni</a></li>
		</ul>
	</div>

	<section id="user_existing" class="row">
		<div class="page-header">
			<h1>CSV Process</h1>
		</div>
		<h2>Quando un utente esiste ...</h2>
  </section>
</div>
