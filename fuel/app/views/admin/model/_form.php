	...
	<fieldset>
		...
		<div class="form-group">
			<?php echo Form::label(__('admin.DifficultIndex'), 'difficult_index', array('class'=>'control-label')); ?>
				...
				<?php echo Form::input('difficult_index', Input::post('difficult_index', isset($model) ? $model->difficult_index : ''), array('class' => 'col-md-4 form-control', 'placeholder'=>__('admin.DifficultIndex'))); ?>
